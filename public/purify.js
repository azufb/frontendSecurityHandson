...
!(function (e, t) {
  ...
  var re = (function t() {
    ...
    var Tt = function (e) {
      ...
      Ot = function (e, t, n) {
        if (We && ('id' === t || 'name' === t) && (n in i || n in ft))
          return !1;
        if (Me && !Ce[t] && O(Ne, t));
        else if (Le && O(Ae, t));
        else if (!ke[t] || Ce[t]) {
    ...
    return (
      (r.sanitize = function (e) {
        ...
        for (var m = wt(Ke ? e : t); (a = m.nextNode()); )
          kt(a) || (a.content instanceof l && Ct(a.content), Rt(a));
        if (Ke) return e;
        if (Pe) {
          if (Be)
            for (i = fe.call(t.ownerDocument); t.firstChild; )
        ...
        var f = ze ? t.outerHTML : t.innerHTML;
        return (
          ze &&
            _e['!doctype'] &&
            t.ownerDocument &&
          ...
          Fe && ((f = _(f, be, ' ')), (f = _(f, ve, ' ')), (f = _(f, Te, ' '))),
          le && Ge ? le.createHTML(f) : f
        );
      }),
